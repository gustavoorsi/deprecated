...
public class SocialIntegrationConfig implements SocialConfigurer {
	...
	@Autowired
	private SocialMongoConnectionRepository socialMongoConnectionRepository;

	@Override
	public UsersConnectionRepository getUsersConnectionRepository(ConnectionFactoryLocator connectionFactoryLocator) {
		return new MongoUsersConnectionRepository(mongoTemplate, connectionFactoryLocator, textEncryptor(), socialMongoConnectionRepository);
	}
