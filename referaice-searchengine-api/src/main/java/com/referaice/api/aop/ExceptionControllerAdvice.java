...
public class ExceptionControllerAdvice {
	 ...
	 */
	@ResponseBody
	@ExceptionHandler({IllegalArgumentException.class, PersonAlreadyExistException.class})
	@ResponseStatus(HttpStatus.BAD_REQUEST)
	VndErrors illegalArgumentExceptionHandler(Exception ex) {
